...
const Home = () => {
 ...
 <div className="max-w-sm w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
      <div className="flex justify-between">
        <div>
          <h5 className="hidden leading-none text-3xl font-bold text-gray-900 dark:text-white pb-2">32.4k</h5>
          <p className="hidden text-base font-normal text-gray-500 dark:text-gray-400">Users this week</p>
        </div>
